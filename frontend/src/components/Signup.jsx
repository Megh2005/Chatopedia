      ...
      <div className="flex h-screen items-center justify-center">
        ...
        >
          ...
          <div className="flex justify-between flex-col items-center">
            <input type="submit" value="Register" className="text-white bg-green-700 px-2 py-1 w-32 rounded-lg font-bold cursor-pointer hover:bg-blue-700 duration-500 ease-in-out" />
